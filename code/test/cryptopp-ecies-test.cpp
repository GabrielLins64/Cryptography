...
void SavePrivateKey(const PrivateKey& key, const string& file = "res/ecies.private.key");
void SavePublicKey(const PublicKey& key, const string& file = "res/ecies.public.key");

void LoadPrivateKey(PrivateKey& key, const string& file = "res/ecies.private.key");
void LoadPublicKey(PublicKey& key, const string& file = "res/ecies.public.key");
